...
contract ETHOperationAURAstafiTest is OperationTest {
    function setUp() public override {
        //super.setUp();
        uint256 mainnetFork = vm.createFork("mainnet");
        vm.selectFork(mainnetFork);

        //asset from https://docs.pendle.finance/Developers/Deployments/: Markets --> PT-StaFirETH-WETH BalancerLP Aura-27JUN24/SY-StaFirETH-WETH BalancerLP Aura Market --> asset
        asset = ERC20(0xd1434df1E2Ad0Cb7B3701a751D01981c7Cf2Dd62); //PT-StaFirETH-WETH BalancerLP Aura-27JUN24/SY-StaFirETH-WETH BalancerLP Aura Market
        //targetToken from asset --> readTokens --> SY --> getTokensIn --> targetToken
        targetToken = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; //wstETH
