...
contract ARBOperationStargateUSDTTest is OperationTest {
    function setUp() public override {
        //super.setUp();
        uint256 arbitrumFork = vm.createFork("arbitrum");
        vm.selectFork(arbitrumFork);

        //asset from https://docs.pendle.finance/Developers/Deployments/: Markets --> PT-Stargate-USDT-27JUN24/SY-Stargate-USDT Market --> asset
        asset = ERC20(0x0A21291A184cf36aD3B0a0def4A17C12Cbd66A14); //PT-Stargate-USDT-27JUN24/SY-Stargate-USDT Market
        //targetToken from asset --> readTokens --> SY --> getTokensIn --> targetToken
        targetToken = 0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9; //USDT
